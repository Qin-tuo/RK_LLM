...
This directory is intentionally empty. RKLLM Runtime headers are supplied externally by the official Rockchip SDK or runtime release and are never copied into this repository.
